  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-5 center pt-10 bg-white pb-40 pt-40">
          ...
          <button className="btn font-spartan text-white bg-background-10 regular-24 border-background-10 hover:border-background-10 hover:bg-white hover:text-background-10">Sign up</button>
      </div>
      <Footer/>
    </div>
